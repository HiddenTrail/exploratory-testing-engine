...
SUT) or its oracle library - a clean slate: `run_oracle_pass.py` judges every "model"-type
entry (22 when this ran) in [the heuristics catalog](../oracle-agent-poc/heuristics/catalog.json) fresh, against a
